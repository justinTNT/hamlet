 ...
 * 
 * Generates type-safe KV store APIs from Rust models in app/horatio/models/kv/
...
const MODELS_DIR = PROJECT_NAME ? path.join(process.cwd(), `app/${PROJECT_NAME}/models/kv`) : null;
const OUTPUT_FILE = path.join(process.cwd(), 'generated/kv-store.js');
 ...
 * Generated from models in app/horatio/models/kv/
 * 
