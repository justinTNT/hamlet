...
> **HISTORICAL**: This document describes the old restructure plan. The packages mentioned (`hamlet-cli`, `hamlet-core`) have been consolidated into `packages/buildamp/`. See `CLAUDE.md` for current architecture.
