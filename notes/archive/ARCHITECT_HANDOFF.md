...
> **OUTDATED**: This document describes the old restructure plan using `hamlet-cli`, `hamlet-core`, and `hamlet-contracts` packages. These have been consolidated into a single `packages/buildamp/` package. See `CLAUDE.md` for current architecture.

**Date**: 2026-01-04 (Original) | 2026-01-16 (Marked Outdated)
**Status**: SUPERSEDED - BuildAmp package consolidation complete
