...
### vs Lamdera
- **BuildAmp:** Use any backend, integrate with existing projects
- **Lamdera:** Full framework replacement, vendor lock-in

### vs elm-pages  
- **BuildAmp:** Focus on client↔server boundary only
- **elm-pages:** Opinionated full-stack framework

### vs Manual JSON
- **BuildAmp:** Zero boilerplate, compile-time safety
- **Manual:** Massive boilerplate, runtime errors

### vs GraphQL Codegen
- **BuildAmp:** Direct Rust↔Elm types, simpler setup  
- **GraphQL:** Extra abstraction layer, schema complexity
