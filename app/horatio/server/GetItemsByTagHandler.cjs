...
var $author$project$Api$Scripts$GetItemsByTag$decodeRequest = $author$project$BuildAmp$Api$getItemsByTagReqDecoder;
...
var $author$project$Api$Scripts$GetItemsByTag$encodeResponse = $author$project$BuildAmp$Api$getItemsByTagResEncoder;
...
var $author$project$Api$Scripts$GetItemsByTag$toFeedItem = function (dbItem) {
...
var $author$project$Api$Scripts$GetItemsByTag$filterItemsByTag = F4(
	function (tagName, items, allTags, itemTags) {
		...
		if (maybeTagId.$ === 'Just') {
			...
			return A2(
				$elm$core$List$map,
				$author$project$Api$Scripts$GetItemsByTag$toFeedItem,
				A2(
					$elm$core$List$filter,
					function (item) {
...
var $author$project$Backend$Script$Desc = {$: 'Desc'};
var $author$project$Backend$Script$sortByDesc = F2(
		...
		return _Utils_update(
			query,
			{
				sort: _Utils_ap(
					...
					_List_fromArray(
						[
							{direction: $author$project$Backend$Script$Desc, field: field}
						]))
			});
	});
var $author$project$Backend$Script$succeed = function (a) {
...
var $author$project$Api$Scripts$GetItemsByTag$handler = F3(
	function (req, ctx, config) {
		return A3(
			...
			function (allTags) {
				return A3(
					$author$project$Backend$Script$andThenDecode,
					$elm$json$Json$Decode$list($author$project$BuildAmp$Database$microblogitemDbDecoder),
					function (items) {
						return A3(
							$author$project$Backend$Script$andThenDecode,
							...
							function (itemTags) {
								return $author$project$Backend$Script$succeed(
									{
										items: A4($author$project$Api$Scripts$GetItemsByTag$filterItemsByTag, req.tag, items, allTags, itemTags),
										tag: req.tag
									});
							},
							A2($author$project$Backend$Script$dbFind, 'item_tag', $author$project$Backend$Script$queryAll));
					},
					A2(
						$author$project$Backend$Script$dbFind,
						'microblog_item',
						A2($author$project$Backend$Script$sortByDesc, 'created_at', $author$project$Backend$Script$queryAll)));
			},
...
var $author$project$Api$Handlers$GetItemsByTagHandler$main = $author$project$Backend$Runtime$run(
	{decodeRequest: $author$project$Api$Scripts$GetItemsByTag$decodeRequest, encodeResponse: $author$project$Api$Scripts$GetItemsByTag$encodeResponse, handler: $author$project$Api$Scripts$GetItemsByTag$handler});
