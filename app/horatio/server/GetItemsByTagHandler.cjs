...
var $author$project$Api$Handlers$GetItemsByTagHandler$Idle = {$: 'Idle'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Api$Handlers$GetItemsByTagHandler$init = function (flags) {
	return _Utils_Tuple2(
		{allTags: _List_Nil, context: $elm$core$Maybe$Nothing, globalConfig: flags.globalConfig, globalState: flags.globalState, itemTags: _List_Nil, loadedItems: _List_Nil, request: $elm$core$Maybe$Nothing, stage: $author$project$Api$Handlers$GetItemsByTagHandler$Idle},
		$elm$core$Platform$Cmd$none);
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $elm$json$Json$Decode$string = _Json_decodeString;
var $author$project$Api$Handlers$GetItemsByTagHandler$AllTagsLoaded = function (a) {
	return {$: 'AllTagsLoaded', a: a};
};
var $author$project$Api$Handlers$GetItemsByTagHandler$HandleRequest = function (a) {
	return {$: 'HandleRequest', a: a};
};
var $author$project$Api$Handlers$GetItemsByTagHandler$ItemTagsLoaded = function (a) {
	return {$: 'ItemTagsLoaded', a: a};
};
var $author$project$Api$Handlers$GetItemsByTagHandler$ItemsLoaded = function (a) {
...
var $author$project$Api$Handlers$GetItemsByTagHandler$handleRequest = _Platform_incomingPort(
	'handleRequest',
	A2(
		$elm$json$Json$Decode$andThen,
		function (request) {
...
var $author$project$Api$Handlers$GetItemsByTagHandler$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Api$Handlers$GetItemsByTagHandler$handleRequest($author$project$Api$Handlers$GetItemsByTagHandler$HandleRequest),
				$author$project$BuildAmp$Database$dbResult($author$project$Api$Handlers$GetItemsByTagHandler$AllTagsLoaded),
				$author$project$BuildAmp$Database$dbResult($author$project$Api$Handlers$GetItemsByTagHandler$ItemsLoaded),
				$author$project$BuildAmp$Database$dbResult($author$project$Api$Handlers$GetItemsByTagHandler$ItemTagsLoaded)
			]));
};
var $author$project$Api$Handlers$GetItemsByTagHandler$Complete = function (a) {
	return {$: 'Complete', a: a};
};
var $author$project$Api$Handlers$GetItemsByTagHandler$Failed = function (a) {
	return {$: 'Failed', a: a};
};
var $author$project$Api$Handlers$GetItemsByTagHandler$LoadingAllTags = {$: 'LoadingAllTags'};
var $author$project$Api$Handlers$GetItemsByTagHandler$LoadingItemTags = {$: 'LoadingItemTags'};
var $author$project$Api$Handlers$GetItemsByTagHandler$LoadingItems = {$: 'LoadingItems'};
var $elm$core$Basics$identity = function (x) {
	return x;
};
var $author$project$Api$Handlers$GetItemsByTagHandler$complete = _Platform_outgoingPort('complete', $elm$core$Basics$identity);
...
var $author$project$Api$Handlers$GetItemsByTagHandler$decodeAllTags = function (data) {
	var _v0 = A2(
...
var $author$project$Api$Handlers$GetItemsByTagHandler$decodeItemTags = function (data) {
	var _v0 = A2(
		$elm$json$Json$Decode$decodeValue,
...
var $author$project$Api$Handlers$GetItemsByTagHandler$microblogItemDbDecoder = $author$project$BuildAmp$Database$microblogitemDbDecoder;
var $author$project$Api$Handlers$GetItemsByTagHandler$decodeItems = function (data) {
	var _v0 = A2(
		$elm$json$Json$Decode$decodeValue,
		$elm$json$Json$Decode$list($author$project$Api$Handlers$GetItemsByTagHandler$microblogItemDbDecoder),
		data);
	if (_v0.$ === 'Ok') {
		var items = _v0.a;
...
var $author$project$Api$Handlers$GetItemsByTagHandler$Context = F3(
...
var $author$project$Api$Handlers$GetItemsByTagHandler$contextDecoder = A4(
	$elm$json$Json$Decode$map3,
	$author$project$Api$Handlers$GetItemsByTagHandler$Context,
...
var $author$project$Api$Handlers$GetItemsByTagHandler$decodeRequest = function (bundle) {
	return A3(
		...
		A2(
			$elm$core$Result$mapError,
			$elm$json$Json$Decode$errorToString,
			A2($elm$json$Json$Decode$decodeValue, $author$project$Api$Handlers$GetItemsByTagHandler$contextDecoder, bundle.context)));
};
...
var $author$project$Api$Handlers$GetItemsByTagHandler$encodeError = function (error) {
...
var $author$project$Api$Handlers$GetItemsByTagHandler$transformToFeedItem = function (dbItem) {
...
var $author$project$Api$Handlers$GetItemsByTagHandler$filterItemsByTag = F4(
		...
		var maybeTagId = A2(
			...
			$elm$core$List$head(
				A2(
					...
					function (t) {
						return _Utils_eq(t.name, tagName);
					},
					allTags)));
		if (maybeTagId.$ === 'Just') {
			var tagId = maybeTagId.a;
			var itemIdsWithTag = A2(
				$elm$core$List$map,
				function ($) {
					return $.itemId;
				},
				A2(
					$elm$core$List$filter,
					function (it) {
						return _Utils_eq(it.tagId, tagId);
					},
					itemTags));
			return A2(
				$elm$core$List$map,
				$author$project$Api$Handlers$GetItemsByTagHandler$transformToFeedItem,
				A2(
					$elm$core$List$filter,
					function (item) {
						return A2($elm$core$List$member, item.id, itemIdsWithTag);
					},
					items));
		} else {
			return _List_Nil;
...
var $author$project$Api$Handlers$GetItemsByTagHandler$handleDbResponse = function (response) {
	if (response.success) {
...
var $author$project$Api$Handlers$GetItemsByTagHandler$loadAllTags = $author$project$BuildAmp$Database$findTags($author$project$BuildAmp$Database$queryAll);
...
var $author$project$Api$Handlers$GetItemsByTagHandler$loadItemTags = $author$project$BuildAmp$Database$findItemTags($author$project$BuildAmp$Database$queryAll);
...
var $author$project$Api$Handlers$GetItemsByTagHandler$loadMicroblogItems = $author$project$BuildAmp$Database$findMicroblogItems(
	$author$project$BuildAmp$Database$sortByCreatedAt($author$project$BuildAmp$Database$queryAll));
var $author$project$Api$Handlers$GetItemsByTagHandler$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'HandleRequest':
				var bundle = msg.a;
				var _v1 = $author$project$Api$Handlers$GetItemsByTagHandler$decodeRequest(bundle);
				if (_v1.$ === 'Ok') {
					var _v2 = _v1.a;
					var req = _v2.a;
					var ctx = _v2.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								...
								stage: $author$project$Api$Handlers$GetItemsByTagHandler$LoadingAllTags
							}),
						$author$project$Api$Handlers$GetItemsByTagHandler$loadAllTags);
				} else {
					var error = _v1.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								stage: $author$project$Api$Handlers$GetItemsByTagHandler$Failed(error)
							}),
						$elm$core$Platform$Cmd$none);
				}
			case 'AllTagsLoaded':
				var result = msg.a;
				if (_Utils_eq(model.stage, $author$project$Api$Handlers$GetItemsByTagHandler$LoadingAllTags)) {
					var _v3 = $author$project$Api$Handlers$GetItemsByTagHandler$handleDbResponse(result);
					if (_v3.$ === 'Ok') {
						var data = _v3.a;
						var _v4 = $author$project$Api$Handlers$GetItemsByTagHandler$decodeAllTags(data);
						if (_v4.$ === 'Ok') {
							var tags = _v4.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{allTags: tags, stage: $author$project$Api$Handlers$GetItemsByTagHandler$LoadingItems}),
								$author$project$Api$Handlers$GetItemsByTagHandler$loadMicroblogItems);
						} else {
							var error = _v4.a;
							return _Utils_Tuple2(
								_Utils_update(
								...
								$author$project$Api$Handlers$GetItemsByTagHandler$complete(
									$author$project$Api$Handlers$GetItemsByTagHandler$encodeError(error)));
						}
					} else {
						var error = _v3.a;
						return _Utils_Tuple2(
			...
			case 'ItemsLoaded':
				var result = msg.a;
				if (_Utils_eq(model.stage, $author$project$Api$Handlers$GetItemsByTagHandler$LoadingItems)) {
					var _v5 = $author$project$Api$Handlers$GetItemsByTagHandler$handleDbResponse(result);
					if (_v5.$ === 'Ok') {
						var data = _v5.a;
						var _v6 = $author$project$Api$Handlers$GetItemsByTagHandler$decodeItems(data);
						if (_v6.$ === 'Ok') {
							var items = _v6.a;
							return _Utils_Tuple2(
								_Utils_update(
									model,
									{loadedItems: items, stage: $author$project$Api$Handlers$GetItemsByTagHandler$LoadingItemTags}),
								$author$project$Api$Handlers$GetItemsByTagHandler$loadItemTags);
						} else {
							var error = _v6.a;
							return _Utils_Tuple2(
								_Utils_update(
			...
			default:
				var result = msg.a;
				if (_Utils_eq(model.stage, $author$project$Api$Handlers$GetItemsByTagHandler$LoadingItemTags)) {
					var _v7 = $author$project$Api$Handlers$GetItemsByTagHandler$handleDbResponse(result);
					if (_v7.$ === 'Ok') {
						var data = _v7.a;
						var _v8 = $author$project$Api$Handlers$GetItemsByTagHandler$decodeItemTags(data);
						if (_v8.$ === 'Ok') {
							var itemTagsList = _v8.a;
							var _v9 = model.request;
							if (_v9.$ === 'Just') {
								var req = _v9.a;
								var filteredItems = A4($author$project$Api$Handlers$GetItemsByTagHandler$filterItemsByTag, req.tag, model.loadedItems, model.allTags, itemTagsList);
								var response = {items: filteredItems, tag: req.tag};
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											stage: $author$project$Api$Handlers$GetItemsByTagHandler$Complete(response)
										}),
									$author$project$Api$Handlers$GetItemsByTagHandler$complete(
										$author$project$Api$Handlers$GetItemsByTagHandler$encodeGetItemsByTagRes(response)));
							} else {
								return _Utils_Tuple2(
									_Utils_update(
										model,
										{
											stage: $author$project$Api$Handlers$GetItemsByTagHandler$Failed('No request found')
										}),
									$author$project$Api$Handlers$GetItemsByTagHandler$complete(
										$author$project$Api$Handlers$GetItemsByTagHandler$encodeError('No request found')));
							}
						} else {
							var error = _v8.a;
							return _Utils_Tuple2(
...
var $author$project$Api$Handlers$GetItemsByTagHandler$main = $elm$core$Platform$worker(
	{init: $author$project$Api$Handlers$GetItemsByTagHandler$init, subscriptions: $author$project$Api$Handlers$GetItemsByTagHandler$subscriptions, update: $author$project$Api$Handlers$GetItemsByTagHandler$update});
_Platform_export({'Api':{'Handlers':{'GetItemsByTagHandler':{'init':$author$project$Api$Handlers$GetItemsByTagHandler$main(
	A2(
		$elm$json$Json$Decode$andThen,
		function (globalState) {
			return A2(
