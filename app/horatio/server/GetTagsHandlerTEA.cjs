...
var $author$project$Api$Handlers$GetTagsHandlerTEA$init = function (flags) {
	return _Utils_Tuple2(
		{context: $elm$core$Maybe$Nothing, globalConfig: flags.globalConfig, globalState: flags.globalState, request: $elm$core$Maybe$Nothing, stage: $author$project$Api$Handlers$GetTagsHandlerTEA$Idle},
