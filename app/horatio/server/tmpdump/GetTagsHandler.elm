port module Api.Handlers.GetTagsHandler exposing (main)
...
encodeGetTagsRes response =
    -- TODO: Implement proper encoding based on your GetTagsRes structure
    Encode.object
        [ -- TODO: Add proper fields based on your GetTagsRes structure
        -- Example:
