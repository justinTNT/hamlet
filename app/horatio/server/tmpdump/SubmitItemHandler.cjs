...
var $author$project$Api$Handlers$SubmitItemHandler$init = function (flags) {
	return _Utils_Tuple2(
		{context: $elm$core$Maybe$Nothing, globalConfig: flags.globalConfig, globalState: flags.globalState, request: $elm$core$Maybe$Nothing, stage: $author$project$Api$Handlers$SubmitItemHandler$Idle},
...
var $author$project$Api$Handlers$SubmitItemHandler$subscriptions = function (_v0) {
	return $author$project$Api$Handlers$SubmitItemHandler$handleRequest($author$project$Api$Handlers$SubmitItemHandler$HandleRequest);
};
var $author$project$Api$Handlers$SubmitItemHandler$Complete = function (a) {
	return {$: 'Complete', a: a};
};
var $author$project$Api$Handlers$SubmitItemHandler$Processing = {$: 'Processing'};
...
var $author$project$Api$Handlers$SubmitItemHandler$ProcessingComplete = function (a) {
...
var $author$project$Api$Handlers$SubmitItemHandler$processRequest = function (request) {
	var placeholderResponse = _Debug_todo(
		'Api.Handlers.SubmitItemHandler',
		{
	...
	return A2(
		$elm$core$Task$perform,
		function (_v0) {
			return $author$project$Api$Handlers$SubmitItemHandler$ProcessingComplete(placeholderResponse);
		},
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						...
						stage: $author$project$Api$Handlers$SubmitItemHandler$Processing
					}),
				$author$project$Api$Handlers$SubmitItemHandler$processRequest(bundle.request));
		} else {
			var result = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						stage: $author$project$Api$Handlers$SubmitItemHandler$Complete(result)
					}),
				$author$project$Api$Handlers$SubmitItemHandler$complete(
					$author$project$Api$Handlers$SubmitItemHandler$encodeSubmitItemRes(result)));
		}
	});
