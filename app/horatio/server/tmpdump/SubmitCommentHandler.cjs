...
var $author$project$Api$Handlers$SubmitCommentHandler$subscriptions = function (_v0) {
	return $author$project$Api$Handlers$SubmitCommentHandler$handleRequest($author$project$Api$Handlers$SubmitCommentHandler$HandleRequest);
};
...
var $author$project$Api$Handlers$SubmitCommentHandler$ProcessingComplete = function (a) {
...
var $author$project$Api$Handlers$SubmitCommentHandler$processRequest = function (request) {
	var placeholderResponse = _Debug_todo(
		'Api.Handlers.SubmitCommentHandler',
		{
	...
	return A2(
		$elm$core$Task$perform,
		function (_v0) {
			return $author$project$Api$Handlers$SubmitCommentHandler$ProcessingComplete(placeholderResponse);
		},
	...
	function (msg, model) {
		if (msg.$ === 'HandleRequest') {
			...
			return _Utils_Tuple2(
				...
				$author$project$Api$Handlers$SubmitCommentHandler$processRequest(bundle.request));
		} else {
			var result = msg.a;
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						stage: $author$project$Api$Handlers$SubmitCommentHandler$Complete(result)
					}),
				$author$project$Api$Handlers$SubmitCommentHandler$complete(
					$author$project$Api$Handlers$SubmitCommentHandler$encodeSubmitCommentRes(result)));
		}
	});
var $elm$core$Platform$worker = _Platform_worker;
var $author$project$Api$Handlers$SubmitCommentHandler$main = $elm$core$Platform$worker(
	{init: $author$project$Api$Handlers$SubmitCommentHandler$init, subscriptions: $author$project$Api$Handlers$SubmitCommentHandler$subscriptions, update: $author$project$Api$Handlers$SubmitCommentHandler$update});
