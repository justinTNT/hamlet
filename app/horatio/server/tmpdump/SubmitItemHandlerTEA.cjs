...
var $author$project$Api$Handlers$SubmitItemHandlerTEA$init = function (flags) {
	return _Utils_Tuple2(
		{globalConfig: flags.globalConfig, globalState: flags.globalState, request: $elm$core$Maybe$Nothing, stage: $author$project$Api$Handlers$SubmitItemHandlerTEA$Idle},
...
var $author$project$Api$Handlers$SubmitItemHandlerTEA$subscriptions = function (model) {
...
var $author$project$Api$Handlers$SubmitItemHandlerTEA$encodeSubmitItemRes = function (res) {
	return _Debug_todo(
		'Api.Handlers.SubmitItemHandlerTEA',
		{
			start: {line: 125, column: 5},
			end: {line: 125, column: 15}
		})('Implement SubmitItemRes encoder');
};
...
var $author$project$Api$Handlers$SubmitItemHandlerTEA$processRequest = function (request) {
	...
	return A2(
		$elm$core$Task$perform,
		function (_v0) {
			return $author$project$Api$Handlers$SubmitItemHandlerTEA$ProcessingComplete(placeholderResponse);
		},
		...
		if (msg.$ === 'HandleRequest') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						stage: $author$project$Api$Handlers$SubmitItemHandlerTEA$Complete(result)
					}),
