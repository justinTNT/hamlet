...
var $author$project$Api$Handlers$GetFeedHandlerTEA$init = function (flags) {
	return _Utils_Tuple2(
		{globalConfig: flags.globalConfig, globalState: flags.globalState, request: $elm$core$Maybe$Nothing, stage: $author$project$Api$Handlers$GetFeedHandlerTEA$Idle},
...
var $author$project$Api$Handlers$GetFeedHandlerTEA$encodeGetFeedRes = function (res) {
	return _Debug_todo(
		'Api.Handlers.GetFeedHandlerTEA',
		{
			start: {line: 125, column: 5},
			end: {line: 125, column: 15}
		})('Implement GetFeedRes encoder');
};
...
var $author$project$Api$Handlers$GetFeedHandlerTEA$processRequest = function (request) {
	...
	return A2(
		$elm$core$Task$perform,
		function (_v0) {
			return $author$project$Api$Handlers$GetFeedHandlerTEA$ProcessingComplete(placeholderResponse);
		},
