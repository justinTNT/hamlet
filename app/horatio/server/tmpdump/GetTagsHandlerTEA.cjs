...
var $author$project$Api$Handlers$GetTagsHandlerTEA$Idle = {$: 'Idle'};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$Api$Handlers$GetTagsHandlerTEA$init = function (flags) {
	return _Utils_Tuple2(
		{globalConfig: flags.globalConfig, globalState: flags.globalState, request: $elm$core$Maybe$Nothing, stage: $author$project$Api$Handlers$GetTagsHandlerTEA$Idle},
	...
	A2(
		...
		A2(
			...
			A2(
				...
				A2($elm$json$Json$Decode$field, 'host', $elm$json$Json$Decode$string)))));
var $author$project$Api$Handlers$GetTagsHandlerTEA$subscriptions = function (model) {
...
var $author$project$Api$Handlers$GetTagsHandlerTEA$encodeGetTagsRes = function (res) {
	return _Debug_todo(
		'Api.Handlers.GetTagsHandlerTEA',
		{
			start: {line: 125, column: 5},
			end: {line: 125, column: 15}
		})('Implement GetTagsRes encoder');
};
...
var $author$project$Api$Handlers$GetTagsHandlerTEA$processRequest = function (request) {
	...
	return A2(
		$elm$core$Task$perform,
		function (_v0) {
			return $author$project$Api$Handlers$GetTagsHandlerTEA$ProcessingComplete(placeholderResponse);
		},
		$elm$core$Task$succeed(_Utils_Tuple0));
};
var $author$project$Api$Handlers$GetTagsHandlerTEA$update = F2(
	function (msg, model) {
		if (msg.$ === 'HandleRequest') {
			...
			return _Utils_Tuple2(
				_Utils_update(
					model,
					{
						stage: $author$project$Api$Handlers$GetTagsHandlerTEA$Complete(result)
					}),
