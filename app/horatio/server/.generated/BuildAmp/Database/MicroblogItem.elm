module BuildAmp.Database.MicroblogItem exposing (..)
...
Use these with Interface.Query operators for compile-time safe queries:
    ...
    import BuildAmp.Database.MicroblogItem as MicroblogItem
...
import BuildAmp.Database exposing (MicroblogItemDb)
