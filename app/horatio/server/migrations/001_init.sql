...
CREATE INDEX IF NOT EXISTS idx_items_timestamp ON microblog_items(created_at DESC);
...
INSERT INTO microblog_items (id, host, title, link, image, extract, owner_comment, created_at)
VALUES (
    '1',
    'localhost',
