...
Business Logic:
TODO: Customize the stages and business logic for your specific GetItem endpoint
...
update msg model =
    case msg of
        ...
        ProcessingComplete result ->
            ...
            , complete (encodeGetItemRes result)
            )
...
processRequest : GetItemReq -> Cmd Msg
processRequest request =
    ...
    let
        placeholderResponse = Debug.todo "Implement GetItem handler"
    in
    Task.perform (\_ -> 
...
updateWithResponse msg model =
    ...
    case newModel.stage of
        Complete response ->
            ( newModel
            , Cmd.batch
                [ complete (encodeGetItemRes response)
                , cmd
                ]
            )
