module Events.Backend exposing (HardDeletesPayload, hardDeletesPayloadDecoder, EventContext, EventResult(..), eventContextDecoder, encodeEventResult)
...
@docs HardDeletesPayload
@docs hardDeletesPayloadDecoder
