...
let Dr = null;
function Wr() {
  return (Dr === null || Dr.byteLength === 0) && (Dr = new Uint8Array(F.memory.buffer)), Dr;
}
function Tr(r, n, t) {
  if (t === void 0) {
    const $ = Mr.encode(r), c = n($.length, 1) >>> 0;
    return Wr().subarray(c, c + $.length).set($), pr = $.length, c;
  }
...
let $n = 0;
function be(r, n) {
  return $n += n, $n >= _e && (zr = new TextDecoder("utf-8", { ignoreBOM: true, fatal: true }), zr.decode(), $n = n), zr.decode(Wr().subarray(r, r + n));
}
...
function he(r) {
  let n, t;
  try {
    const e = Tr(r, F.__wbindgen_malloc_command_export, F.__wbindgen_realloc_command_export), a = pr, u = F.create_session_id(e, a);
...
function de(r, n) {
  let t, e;
  try {
    const a = Tr(r, F.__wbindgen_malloc_command_export, F.__wbindgen_realloc_command_export), u = pr, i = Tr(n, F.__wbindgen_malloc_command_export, F.__wbindgen_realloc_command_export), $ = pr, c = F.decode_response(a, u, i, $);
...
function ge(r, n) {
  let t, e;
  try {
    const a = Tr(r, F.__wbindgen_malloc_command_export, F.__wbindgen_realloc_command_export), u = pr, i = Tr(n, F.__wbindgen_malloc_command_export, F.__wbindgen_realloc_command_export), $ = pr, c = F.encode_request(a, u, i, $);
    return t = c[0], e = c[1], jn(c[0], c[1]);
  } finally {
    F.__wbindgen_free_command_export(t, e, 1);
  }
...
function Ae(r, n) {
  return F = r.exports, ht.__wbindgen_wasm_module = n, Dr = null, F.__wbindgen_start(), F;
}
async function ht(r) {
  if (F !== void 0) return F;
  typeof r < "u" && (Object.getPrototypeOf(r) === Object.prototype ? { module_or_path: r } = r : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), typeof r > "u" && (r = new URL("/assets/proto_rust_bg-Dkfl8lyD.wasm", import.meta.url));
  const n = De();
...
function mn(r, n, t, e) {
  ...
  if (t > 100) return e.push(D(r, n)), true;
  r.$ < 0 && (r = nt(r), n = nt(n));
...
function W(r, n, t) {
  ...
  if (typeof r.$ > "u") return (t = W(r.a, n.a)) || (t = W(r.b, n.b)) ? t : W(r.c, n.c);
  for (; r.b && n.b && !(t = W(r.a, n.a)); r = r.b, n = n.b) ;
...
f(Math.atan2);
var Pe = Math.ceil, Oe = Math.floor, Qn = Math.log;
f(function(r, n) {
  return r && n;
});
f(function(r, n) {
...
function Le(r) {
  ...
  return isNaN(n) ? J : P(55296 <= n && n <= 56319 ? D(r[0] + r[1], r.slice(2)) : D(r[0], r.slice(1)));
}
f(function(r, n) {
  return r + n;
});
...
var ua = f(function(r, n) {
  try {
    ...
    return U(o(Pn, "This is not valid JSON! " + e.message, n));
  }
}), oa = f(function(r, n) {
  return q(r, n);
});
...
function ia(r) {
  return o(Pu, r.length, function(n) {
    return r[n];
  });
}
function K(r, n) {
  return U(o(Pn, "Expecting " + r, n));
}
function dr(r, n) {
  if (r === n) return true;
  if (r.$ !== n.$) return false;
...
function Fn(r, n, t, e, a, u) {
  ...
  function s(m, A) {
    var j = o(e, m, l);
    v(l = j.a, A), Nn($, j.b, a(l));
  }
  return Nn($, c.b, a(l)), p ? { ports: p } : {};
}
var gr = {};
function wa(r, n) {
  var t;
...
var Ca = /^\s*j\s*a\s*v\s*a\s*s\s*c\s*r\s*i\s*p\s*t\s*:/i, Ba = /^\s*(j\s*a\s*v\s*a\s*s\s*c\s*r\s*i\s*p\s*t\s*:|d\s*a\s*t\s*a\s*:\s*t\s*e\s*x\s*t\s*\/\s*h\s*t\s*m\s*l\s*(,|;))/i;
function Va(r) {
  return Ca.test(r) ? "" : r;
}
function Pa(r) {
...
function Ht(r) {
  for (var n = {}; r.b; r = r.b) {
    ...
    if (e === "a2") {
      a === "className" ? xn(n, a, u) : n[a] = u;
      continue;
    }
    var i = n[e] || (n[e] = {});
    e === "a3" && a === "class" ? xn(i, a, u) : i[a] = u;
  }
  return n;
}
function xn(r, n, t) {
...
function or(r, n) {
  ...
  for (var $ = r.e, c = 0; c < $.length; c++) Tn(i, or(t === 1 ? $[c] : $[c].b, n));
  return i;
}
function bn(r, n, t) {
  for (var e in t) {
    var a = t[e];
    e === "a1" ? ya(r, a) : e === "a0" ? za(r, n, a) : e === "a3" ? Ua(r, a) : e === "a4" ? Wa(r, a) : (e !== "value" && e !== "checked" || r[e] !== a) && (r[e] = a);
  }
}
function ya(r, n) {
  var t = r.style;
...
function za(r, n, t) {
  ...
  for (var a in t) {
    ...
    i = ka(n, u), r.addEventListener(a, i, Cn && { passive: Ln(u) < 2 }), e[a] = i;
  }
}
var Cn;
try {
  ...
  if (r !== n) {
    ...
    switch (u) {
      case 5:
        ...
        return;
      case 4:
        for (var p = r.j, s = n.j, m = false, A = r.k; A.$ === 4; ) m = true, typeof p != "object" ? p = [p, A.j] : p.push(A.j), A = A.k;
        for (var j = n.k; j.$ === 4; ) m = true, typeof s != "object" ? s = [s, j.j] : s.push(j.j), j = j.k;
        if (m && p.length !== s.length) {
          O(t, 0, e, n);
          return;
        }
        (m ? !Ga(p, s) : p !== s) && O(t, 2, e, s), Q(A, j, t, e + 1);
        return;
      case 0:
        r.a !== n.a && O(t, 3, e, n.a);
        return;
...
function Ya(r, n, t, e) {
  for (var a = [], u = {}, i = [], $ = r.e, c = n.e, l = $.length, v = c.length, p = 0, s = 0, m = e; p < l && s < v; ) {
    var A = $[p], j = c[s], H = A.a, R = j.a, E = A.b, L = j.b, tr = void 0, an = void 0;
    if (H === R) {
    ...
    if (tr && an) {
      m++, Q(E, on, a, m), Ar(u, a, H, L, s, i), m += E.b || 0, m++, Er(u, a, H, hr, m), m += hr.b || 0, p += 2, s += 2;
      continue;
    }
    if (tr) {
      m++, Ar(u, a, R, L, s, i), Q(E, on, a, m), m += E.b || 0, p += 1, s += 2;
      continue;
    }
    if (an) {
    ...
    if (Lr && qn === Gn) {
      m++, Er(u, a, H, E, m), Ar(u, a, R, L, s, i), m += E.b || 0, m++, Q(hr, on, a, m), m += hr.b || 0, p += 2, s += 2;
      continue;
    }
    break;
  }
  for (; p < l; ) {
    m++;
    var A = $[p], E = A.b;
    Er(u, a, A.a, E, m), m += E.b || 0, p++;
  }
  for (; s < v; ) {
    var Ir = Ir || [], j = c[s];
    Ar(u, a, j.a, j.b, void 0, Ir), s++;
  }
  (a.length > 0 || i.length > 0 || Ir) && O(t, 8, e, { w: a, x: i, y: Ir });
}
var Rt = "_elmW6BL";
function Ar(r, n, t, e, a, u) {
  var i = r[t];
  if (!i) {
...
function jr(r, n, t, e, a, u, i) {
  ...
  for (var A = n.e, j = r.childNodes, H = 0; H < A.length; H++) {
    a++;
    var R = s === 1 ? A[H] : A[H].b, E = a + (R.b || 0);
...
function Vn(r) {
  ...
  for (var $ = r.tagName.toLowerCase(), c = w, l = r.childNodes, e = l.length; e--; ) c = nr(Vn(l[e]), c);
  return d(k, $, n, c);
}
function xa(r) {
...
var ru = z(function(r, n, t, e) {
  return Fn(n, e, r.bk, r.bx, r.bu, function(a, u) {
    var i = r.bz, $ = e.node, c = Vn($);
...
z(function(r, n, t, e) {
  return Fn(n, e, r.bk, r.bx, r.bu, function(a, u) {
    var i = r.ak && r.ak(a), $ = r.bz, c = mr.title, l = mr.body, v = Vn(l);
    return Tt(u, function(p) {
      Qr = i;
      var s = $(p), m = k("body")(w)(s.I), A = Jt(v, m);
      l = Ft(l, v, A, a), v = m, Qr = 0, c !== s.ag && (mr.title = c = s.ag);
    });
  });
});
...
S(function(r, n, t) {
  return Rn(X(function(e) {
    ...
    return r.addEventListener(n, a, Cn && { passive: true }), function() {
...
function vu(r, n, t) {
  n.upload.addEventListener("progress", function(e) {
    n.c || Cr(o($t, r, D(t, vo({ br: e.loaded, a0: e.total }))));
  }), n.addEventListener("progress", function(e) {
    n.c || Cr(o($t, r, D(t, lo({ bp: e.loaded, a0: e.lengthComputable ? P(e.total) : J }))));
  });
}
var Bt = 1, su = 2, Vt = 0, G = Je, Pt = S(function(r, n, t) {
  r: for (; ; ) {
    if (t.$ === -2) return n;
...
var U = function(r) {
  ...
  return { $: 0, a: r };
}, J = { $: 1 }, pu = ze, Lt = $a, Zr = Ge, Hr = f(function(r, n) {
  return o(Ue, r, Jn(n));
}), _u = f(function(r, n) {
  return _(o(ye, r, n));
}), It = function(r) {
...
`, r));
  ...
  return Ut(r) || Wt(r) || Su(r);
}, ir = function(r) {
  return d(Vr, G, w, r);
}, Au = Le, Eu = f(function(r, n) {
  return `
  ...
  r: for (; ; ) switch (r.$) {
    ...
    case 2:
      ...
      if (v.b) if (v.b.b) {
        ...
        }(), A = p + (" failed in the following " + (Zr(yt(v)) + " ways:"));
        return o(Hr, `
...
`;
      ...
      return A + (It(o(Lt, 4, m)) + (`

` + s));
  }
}), Y = 32, hn = z(function(r, n, t, e) {
  return { $: 0, a: r, b: n, c: t, d: e };
}), dn = Me, kt = Pe, qt = f(function(r, n) {
  return Qn(n) / Qn(r);
}), gn = kt(o(qt, 2, Y)), Hu = rr(hn, 0, gn, dn, dn), Gt = Te, Ju = function(r) {
  return { $: 1, a: r };
};
f(function(r, n) {
  return r(n);
...
var Ru = Oe, et = Fe, Mu = f(function(r, n) {
  ...
  if (n.a) {
    var t = n.a * Y, e = Ru(o(qt, Y, t - 1)), a = r ? ir(n.d) : n.d, u = o(Cu, a, n.a);
    return rr(hn, et(n.c) + t, o(Mu, 5, e * gn), u, n.c);
  } else return rr(hn, et(n.c), gn, dn, n.c);
}), Vu = _r(function(r, n, t, e, a) {
  r: for (; ; ) {
...
}), Iu = ke, yu = Ie, Xt = We, rn = f(function(r, n) {
  ...
  if (u.b) {
    ...
    if ($.$ === 1) return J;
    var c = $;
    return P(sn(at, r, o(tn, i, a), c, n, t, e));
  } else return P(sn(at, r, a, J, n, t, e));
}), ot = z(function(r, n, t, e) {
  if (Pr(e)) return J;
  var a = o(nn, "/", e);
  if (a.b) {
    var u = a.a;
  ...
  if (e.b) {
    var a = e.a;
    return rr(ot, r, P(o(rn, a + 1, t)), n, o(tn, a, t));
...
f(function(r, n) {
  ...
  if (t.b) {
    var e = t.a;
    return d(it, r, P(o(rn, e + 1, n)), o(tn, e, n));
  } else return d(it, r, J, n);
});
var In = function(r) {
}, ur = br, Wu = ur(0), Zt = z(function(r, n, t, e) {
  if (e.b) {
    var a = e.a, u = e.b;
    if (u.b) {
      var i = u.a, $ = u.b;
      if ($.b) {
        var c = $.a, l = $.b;
        if (l.b) {
          var v = l.a, p = l.b, s = t > 500 ? d(Vr, r, n, ir(p)) : rr(Zt, r, n, t + 1, p);
  ...
  return d(Or, zu(G), ur(w), r);
}, Un = Da, ku = f(function(r, n) {
  var t = n;
...
gr.Task = Dt(Wu, qu, Gu, Qu);
var Yu = At("Task"), Wn = f(function(r, n) {
  return Yu(o(yn, r, n));
  ...
  return zn(_([D("host", I(r.k))]));
}, Nu = function(r) {
  return { aF: r };
}, C = na, T = ra, Sn = Ne, xu = Hn(function(r, n, t, e, a, u, i, $, c) {
  return { aq: $, V: a, r, W: e, Z: t, aa: u, F: i, af: c, ag: n };
}), Nt = Ze, ro = Nr(function(r, n, t, e, a, u, i) {
  return { Q: a, aC: t, r, Y: n, ab: e, ae: u, af: i };
}), no = xe, to = ta, eo = function(r) {
  return to(_([no(J), o(M, P, r)]));
}, y = Ke, xt = o(C, function(r) {
  return o(M, r, o(T, "timestamp", Nt));
}, o(C, function(r) {
  return o(M, r, o(T, "text", y));
}, o(C, function(r) {
  return o(M, r, o(T, "author_name", y));
}, o(C, function(r) {
  return o(M, r, o(T, "parent_id", eo(y)));
}, o(C, function(r) {
  return o(M, r, o(T, "guest_id", y));
}, o(C, function(r) {
  return o(M, r, o(T, "item_id", y));
}, o(C, function(r) {
  return o(M, r, o(T, "id", y));
}, sr(ro)))))))), re = o(C, function(r) {
  return o(M, r, o(T, "timestamp", Nt));
}, o(C, function(r) {
  return o(M, r, o(T, "comments", Sn(xt)));
}, o(C, function(r) {
  return o(M, r, o(T, "tags", Sn(y)));
}, o(C, function(r) {
  return o(M, r, o(T, "owner_comment", y));
}, o(C, function(r) {
  return o(M, r, o(T, "extract", y));
}, o(C, function(r) {
  return o(M, r, o(T, "image", y));
}, o(C, function(r) {
  return o(M, r, o(T, "link", y));
}, o(C, function(r) {
  return o(M, r, o(T, "title", y));
}, o(C, function(r) {
  return o(M, r, o(T, "id", y));
}, sr(xu)))))))))), ao = o(C, function(r) {
  return o(M, r, o(T, "items", Sn(re)));
}, sr(Nu)), uo = function(r) {
  ...
  return { $: 0, a: r };
}, so = { $: 1 }, ar = { $: -2 }, Dn = ar, ne = function(r) {
  return !r.$;
}, $t = Aa, te = je, ee = f(function(r, n) {
  r: for (; ; ) {
    if (n.$ === -2) return J;
  ...
  if (a.$ === -1 && !a.a) {
    ...
    m.a;
    var A = m.b, j = m.c, H = m.d, R = m.e, s = e.e;
    return h(g, 0, l, v, h(g, 1, A, j, H, R), h(g, 1, n, t, s, a));
  ...
  switch (c) {
    case 0:
      return h(wr, e, a, u, d(An, r, n, i), $);
    case 1:
      return h(g, e, a, n, i, $);
    default:
      return h(wr, e, a, u, i, d(An, r, n, $));
  }
}), ae = S(function(r, n, t) {
  var e = d(An, r, n, t);
  if (e.$ === -1 && !e.a) {
  ...
  if (r.$ === -1 && r.d.$ === -1 && r.e.$ === -1) if (r.e.d.$ === -1 && !r.e.d.a) {
    ...
    s.a;
    var m = s.b, A = s.c, j = s.d, H = s.e, R = l.e;
    return h(g, 0, m, A, h(g, 1, t, e, h(g, 0, u, i, $, c), j), h(g, 1, v, p, H, R));
  } else {
  ...
  if (r.$ === -1 && r.d.$ === -1 && r.e.$ === -1) if (r.d.d.$ === -1 && !r.d.d.a) {
    ...
    m.a;
    var A = m.b, j = m.c, H = m.d, R = m.e;
    return h(g, 0, u, i, h(g, 1, c, l, v, p), h(g, 1, t, e, s, h(g, 0, A, j, H, R)));
  } else {
    var n = r.a, t = r.b, e = r.c, E = r.d;
    E.a;
    var u = E.b, i = E.c, L = E.d, s = E.e, tr = r.e;
    tr.a;
    var A = tr.b, j = tr.c, H = tr.d, R = tr.e;
    return h(g, 1, t, e, h(g, 0, u, i, L, s), h(g, 0, A, j, H, R));
  }
  else return r;
}, po = Nr(function(r, n, t, e, a, u, i) {
  if (u.$ === -1 && !u.a) {
    u.a;
  ...
  return { aR: r, a1: n };
}), Mo = ur(o(fe, Dn, w)), Fo = da, To = Rn, qr = S(function(r, n, t) {
  r: for (; ; ) if (n.b) {
    var e = n.a, a = n.b;
    if (e.$) {
      var p = e.a;
...
gr.Http = Dt(Mo, Co, Oo, Io, Uo);
var Wo = At("Http"), zo = function(r) {
  return Wo(ce({ ba: false, I: r.I, bf: r.bf, bh: r.bh, bl: r.bl, bv: r.bv, bw: r.bw, by: r.by }));
}, kn = f(function(r, n) {
  return zo({ I: Ro(n.I), bf: o(jo, r, n.J), bh: _([o(Jo, "X-RPC-Endpoint", n.K)]), bl: "POST", bv: J, bw: J, by: "/api" });
}), En = o(kn, Zu, uo({ k: "localhost" })), ko = D({ Q: "", n: wn, t: "", z: J }, En), qo = Et, Go = qo(w), ln = function(r) {
  return { $: 2, a: r };
}, Qo = function(r) {
  return { $: 1, a: r };
}, vn = function(r) {
  ...
  return zn(_([D("host", I(r.k)), D("item_id", I(r.Y)), D("parent_id", o(ft, st(vt), lt(I))(r.ab)), D("text", I(r.ae)), D("author_name", o(ft, st(vt), lt(I))(r.Q))]));
}, Ko = function(r) {
  return { ap: r };
}, No = o(C, function(r) {
  return o(M, r, o(T, "comment", xt));
}, sr(Ko)), xo = function(r) {
  return { I: Zo(r), J: No, K: "SubmitComment" };
}, ri = function(r) {
  var n = r.z;
  if (n.$) return er;
  var t = n.a.Y, e = n.a.ab;
  return o(kn, Xo, xo({ Q: Pr(r.Q) ? J : P(r.Q), k: "localhost", Y: t, ab: e, ae: r.t }));
}, ni = function(r) {
  return { $: 2, a: r };
}, ti = f(function(r, n) {
  return d(Vr, sa(r), fa(), n);
}), ei = function(r) {
  return zn(_([D("host", I(r.k)), D("title", I(r.ag)), D("link", I(r.Z)), D("image", I(r.W)), D("extract", I(r.V)), D("owner_comment", I(r.aa)), D("tags", ti(I)(r.F))]));
}, ai = function(r) {
  return { aE: r };
}, ui = o(C, function(r) {
  return o(M, r, o(T, "item", re));
}, sr(ai)), oi = function(r) {
  ...
  switch (r.$) {
    ...
    case 1:
      if (r.a.$) {
        var e = r.a.a;
        return D(Z(n, { n: ln("Failed to fetch feed: " + vn(e)) }), er);
      } else {
        var t = r.a.a;
        return D(Z(n, { n: Qo(t.aF) }), er);
      }
    case 2:
      if (r.a.$) {
        var e = r.a.a;
        return D(Z(n, { n: ln("Failed to submit item: " + vn(e)) }), er);
      } else {
        var t = r.a.a;
        return D(Z(n, { n: wn }), En);
      }
    case 3:
      var a = r.a, u = r.b;
      return D(Z(n, { t: "", z: P({ Y: a, ab: u }) }), er);
    case 4:
      var i = r.a;
      return D(Z(n, { t: i }), er);
    case 5:
    ...
    case 7:
      if (r.a.$) {
        var e = r.a.a;
        return D(Z(n, { n: ln("Failed to submit comment: " + vn(e)) }), er);
      } else return D(Z(n, { n: wn, t: "", z: J }), En);
    default:
      return D(Z(n, { t: "", z: J }), er);
  }
...
}, si = Ma, b = si, mi = _n, V = mi, ve = k("h2"), pi = k("a"), se = f(function(r, n) {
  return d(Or, f(function(t, e) {
  ...
  return o(en, "href", Va(r));
}, di = k("img"), gi = k("p"), wi = k("section"), Si = function(r) {
  return o(en, "src", Pa(r));
}, Di = f(function(r, n) {
  return o(se, function(t) {
    return $r(t.ab, P(r));
  }, n);
}), Ai = { $: 8 }, Ei = { $: 6 }, ji = function(r) {
  return { $: 5, a: r };
}, Hi = function(r) {
  return { $: 4, a: r };
}, mt = f(function(r, n) {
  ...
  return d(Or, T, n, r);
}), Ci = o(Ti, _(["target", "value"]), y), pt = function(r) {
  return o(Fi, "input", o(M, Ri, o(M, r, Ci)));
}, _t = en("placeholder"), Bi = k("textarea"), bt = en("value"), me = S(function(r, n, t) {
  var e = r.z;
  if (e.$) return o(Jr, _([Rr(o(mt, n, t)), o(b, "font-size", "0.8em"), o(b, "color", "gray"), o(b, "background", "none"), o(b, "border", "none"), o(b, "cursor", "pointer"), o(b, "text-decoration", "underline")]), _([V("Reply")]));
  var a = e.a;
  return $r(a.Y, n) && $r(a.ab, t) ? o(B, _([o(b, "margin-top", "5px"), o(b, "background", "#f0f0f0"), o(b, "padding", "10px")]), _([o(Ji, _([_t("Your Name (Optional for returning users)"), bt(r.Q), pt(ji), o(b, "display", "block"), o(b, "margin-bottom", "5px"), o(b, "width", "100%")]), w), o(Bi, _([_t("Write a reply..."), bt(r.t), pt(Hi), o(b, "width", "100%"), o(b, "height", "60px")]), w), o(B, _([o(b, "margin-top", "5px")]), _([o(Jr, _([Rr(Ei), o(b, "margin-right", "5px")]), _([V("Submit")])), o(Jr, _([Rr(Ai)]), _([V("Cancel")]))]))])) : o(Jr, _([Rr(o(mt, n, t)), o(b, "font-size", "0.8em"), o(b, "color", "gray"), o(b, "background", "none"), o(b, "border", "none"), o(b, "cursor", "pointer"), o(b, "text-decoration", "underline")]), _([V("Reply")]));
}), pe = z(function(r, n, t, e) {
  return o(B, _([o(b, "margin-left", "20px"), o(b, "margin-top", "10px"), o(b, "border-left", "2px solid #eee"), o(b, "padding-left", "10px")]), _([o(B, _([o(b, "font-weight", "bold"), o(b, "font-size", "0.9em")]), _([V(e.Q)])), o(B, w, _([V(e.ae)])), d(me, r, n, P(e.r)), o(B, w, o(Br, d(pe, r, n, t), o(Di, e.r, t)))]));
}), Vi = function(r) {
  return o(B, _([o(b, "display", "inline-block"), o(b, "background-color", "#e0e0e0"), o(b, "color", "#333"), o(b, "padding", "2px 8px"), o(b, "border-radius", "12px"), o(b, "font-size", "0.85em"), o(b, "margin-right", "5px")]), _([V(r)]));
}, Pi = f(function(r, n) {
  return o(wi, _([o(b, "border", "1px solid #ddd"), o(b, "padding", "15px"), o(b, "margin-bottom", "15px"), o(b, "border-radius", "8px")]), _([o(ve, w, _([V(n.ag)])), o(pi, _([hi(n.Z), o(b, "color", "blue")]), _([V(n.Z)])), o(B, _([o(b, "margin", "10px 0")]), _([o(di, _([Si(n.W), o(b, "max-width", "100%"), o(b, "height", "auto")]), w)])), o(gi, w, _([V(n.V)])), o(B, _([o(b, "margin-bottom", "10px")]), o(Br, Vi, n.F)), o(B, _([o(b, "background", "#f9f9f9"), o(b, "padding", "10px"), o(b, "font-style", "italic")]), _([V("Owner: " + n.aa)])), o(B, _([o(b, "margin-top", "20px"), o(b, "border-top", "1px solid #eee"), o(b, "padding-top", "10px")]), _([o(bi, w, _([V("Comments")])), o(B, w, o(Br, d(pe, r, n.r, n.aq), _i(n.aq))), d(me, r, n.r, J)]))]));
}), Oi = function(r) {
  var n = r.n;
  switch (n.$) {
    case 0:
      return o(B, w, _([V("Loading Feed...")]));
    case 1:
      var t = n.a;
      return o(B, w, o(Br, Pi(r), t));
    default:
      var e = n.a;
      return o(B, _([o(b, "color", "red")]), _([o(ve, w, _([V("Error")])), o(B, w, _([V(e)]))]));
  }
}, Li = function(r) {
  return o(B, _([o(b, "font-family", "sans-serif"), o(b, "max-width", "800px"), o(b, "margin", "0 auto"), o(b, "padding", "20px")]), _([o(fi, w, _([V("Horatio Reader")])), o(Jr, _([Rr(ci), o(b, "margin-bottom", "20px")]), _([V("Test: Submit Item")])), Oi(r)]));
}, Ii = Xu({ bk: function(r) {
  return ko;
}, bu: function(r) {
  return Go;
...
async function Ui() {
  return { canvas: await Wi(), webgl: await zi(), fonts: await ki(), performance: qi() };
}
async function Wi() {
...
async function Gi() {
  ...
  console.log("Elm app initialized."), r.ports && r.ports.log && r.ports.log.subscribe((n) => {
    console.log("ELM:", n);
