...
function Qr(r, n, t) {
  if (t === void 0) {
    const $ = Rr.encode(r), c = n($.length, 1) >>> 0;
  ...
  if (i !== e) {
    ...
    const $ = Wr().subarray(a + i, a + e), c = Rr.encodeInto(r, $);
...
const Rr = new TextEncoder();
"encodeInto" in Rr || (Rr.encodeInto = function(r, n) {
  const t = Rr.encode(r);
...
async function ht(r) {
  ...
  typeof r < "u" && (Object.getPrototypeOf(r) === Object.prototype ? { module_or_path: r } = r : console.warn("using deprecated parameters for the initialization function; pass a single object instead")), typeof r > "u" && (r = new URL("/assets/proto_rust_bg-DXckjUQA.wasm", import.meta.url));
  const n = De();
...
f(function(r, n) {
  return _(Hn(n).sort(function(t, e) {
    return z(r(t), r(e));
  }));
});
f(function(r, n) {
...
f(Math.atan2);
var Ve = Math.ceil, Oe = Math.floor, yn = Math.log;
f(function(r, n) {
  return r && n;
});
f(function(r, n) {
...
function Pe(r) {
  ...
  return isNaN(n) ? J : O(55296 <= n && n <= 56319 ? A(r[0] + r[1], r.slice(2)) : A(r[0], r.slice(1)));
}
f(function(r, n) {
  return r + n;
});
...
function Q(r, n) {
  switch (r.$) {
    ...
    case 3:
      return Ir(n) ? Gn(r.b, n, _) : K("a LIST", n);
    case 4:
...
k(function(r, n, t, e) {
  return Rn(n, e, r.bk, r.bx, r.bu, function() {
    return function() {
    };
  });
});
function Rn(r, n, t, e, a, u) {
...
f(function(r, n) {
  return n.$ === "a0" ? o(Et, n.n, Oa(r, n.o)) : n;
});
function Oa(r, n) {
  var t = Pn(n);
  return { $: n.$, a: t ? d(Ou, t < 3 ? Pa : La, sr(r), n.a) : o(R, r, n.a) };
}
...
function or(r, n) {
  ...
  Gr && r.c == "a" && i.addEventListener("click", Gr(i)), bn(i, n, r.d);
...
function za(r, n, t) {
  ...
  for (var a in t) {
    ...
    i = ka(n, u), r.addEventListener(a, i, Bn && { passive: Pn(u) < 2 }), e[a] = i;
  }
}
var Bn;
try {
...
function ka(r, n) {
  function t(e) {
    var a = t.q, u = Q(a.a, e);
    if (N(u)) {
      for (var i = Pn(a), $ = u.a, c = i ? i < 3 ? $.a : $.s : $, l = i == 1 ? $.b : i == 3 && $.am, v = (l && e.stopPropagation(), (i == 2 ? $.b : i == 3 && $.aj) && e.preventDefault(), r), p, s; p = v.j; ) {
  ...
  if (r !== n) {
    ...
    switch (u) {
      case 5:
        ...
        n.k = n.m();
        var v = [];
        G(r.k, n.k, v, 0), v.length > 0 && P(t, 1, e, v);
        return;
      case 4:
        ...
        (m ? !Qa(p, s) : p !== s) && P(t, 2, e, s), G(S, E, t, e + 1);
        return;
      case 0:
        r.a !== n.a && P(t, 3, e, n.a);
        return;
...
function ya(r, n, t, e) {
  ...
  i > $ ? P(t, 6, e, { v: $, i: i - $ }) : i < $ && P(t, 7, e, { v: i, e: u });
...
function Ga(r, n, t, e) {
  for (var a = [], u = {}, i = [], $ = r.e, c = n.e, l = $.length, v = c.length, p = 0, s = 0, m = e; p < l && s < v; ) {
    var S = $[p], E = c[s], H = S.a, M = E.a, j = S.b, L = E.b, tr = void 0, an = void 0;
    if (H === M) {
    ...
    if (tr && an) {
      m++, G(j, on, a, m), Sr(u, a, H, L, s, i), m += j.b || 0, m++, jr(u, a, H, br, m), m += br.b || 0, p += 2, s += 2;
      continue;
    }
    if (tr) {
      m++, Sr(u, a, M, L, s, i), G(j, on, a, m), m += j.b || 0, p += 1, s += 2;
      continue;
    }
    if (an) {
      m++, jr(u, a, H, j, m), m += j.b || 0, m++, G(br, L, a, m), m += br.b || 0, p += 2, s += 1;
      continue;
    }
    if (Pr && qn === Qn) {
      m++, jr(u, a, H, j, m), Sr(u, a, M, L, s, i), m += j.b || 0, m++, G(br, on, a, m), m += br.b || 0, p += 2, s += 2;
      continue;
    }
    break;
  }
  ...
  (a.length > 0 || i.length > 0 || Lr) && P(t, 8, e, { w: a, x: i, y: Lr });
}
var Mt = "_elmW6BL";
...
function Er(r, n, t, e, a, u, i) {
  ...
  for (var S = n.e, E = r.childNodes, H = 0; H < S.length; H++) {
    a++;
    var M = s === 1 ? S[H] : S[H].b, j = a + (M.b || 0);
    if (a <= c && c <= j && (e = Er(E[H], M, t, e, a, j, i), !($ = t[e]) || (c = $.r) > u)) return e;
    a = j;
  }
  return e;
}
function Ft(r, n, t, e) {
  return t.length === 0 ? r : (Rt(r, n, t, e), Yr(r, t));
}
function Yr(r, n) {
...
var xa = k(function(r, n, t, e) {
  return Rn(n, e, r.bk, r.bx, r.bu, function(a, u) {
...
k(function(r, n, t, e) {
  return Rn(n, e, r.bk, r.bx, r.bu, function(a, u) {
    ...
    return Bt(u, function(p) {
      Gr = i;
      var s = $(p), m = q("body")(w)(s.I), S = Jt(v, m);
...
function lu(r, n, t) {
  n.upload.addEventListener("progress", function(e) {
    ...
    n.c || Br(o(it, r, A(t, fo({ bp: e.loaded, a0: e.lengthComputable ? O(e.total) : J }))));
  });
}
var Ct = 1, vu = 2, Vt = 0, y = He, Ot = D(function(r, n, t) {
  r: for (; ; ) {
    if (t.$ === -2) return n;
    var e = t.b, a = t.c, u = t.d, i = t.e, $ = r, c = d(r, e, a, d(Ot, r, n, i)), l = u;
    r = $, n = c, t = l;
    continue r;
  }
}), rt = function(r) {
  return d(Ot, D(function(n, t, e) {
    return o(y, A(n, t), e);
  }), w, r);
}, Ur = Te;
D(function(r, n, t) {
  ...
  r: for (; ; ) switch (r.$) {
    case 0:
      var t = r.a, i = r.b, e = function() {
        var E = Au(t);
        if (E.$ === 1) return false;
        var H = E.a, M = H.a, j = H.b;
        return gu(M) && o(mu, Du, j);
...
}), dn = Me, qt = Ve, Qt = f(function(r, n) {
  return yn(n) / yn(r);
}), gn = qt(o(Qt, 2, Y)), Eu = rr(hn, 0, gn, dn, dn), yt = Fe, Hu = function(r) {
  return { $: 1, a: r };
};
f(function(r, n) {
  return r(n);
...
var Ju = Oe, tt = Re, Mu = f(function(r, n) {
  return z(r, n) > 0 ? r : n;
}), Ru = function(r) {
  return { $: 0, a: r };
}, Gt = Be, Fu = f(function(r, n) {
  r: for (; ; ) {
    var t = o(Gt, Y, r), e = t.a, a = t.b, u = o(y, Ru(e), n);
    if (a.b) {
      var i = a, $ = u;
      r = i, n = $;
      continue r;
  ...
  if (n.a) {
    ...
    return rr(hn, tt(n.c) + t, o(Mu, 5, e * gn), u, n.c);
  ...
  return !r.$;
}, R = ta, Ou = ea, sr = Ye, Pn = function(r) {
  switch (r.$) {
    case 0:
      return 0;
    case 1:
  ...
  return r;
}, Pu = Yt, et = Kr(function(r, n, t, e, a, u) {
  return { ay: u, k: n, aJ: e, aL: t, aO: r, aP: a };
}), Lu = ke, Iu = Le, Xt = We, rn = f(function(r, n) {
  ...
  if (u.b) {
    ...
    if ($.$ === 1) return J;
    var c = $;
    return O(sn(et, r, o(tn, i, a), c, n, t, e));
  } else return O(sn(et, r, a, J, n, t, e));
  ...
  if (e.b) {
    var a = e.a;
    return rr(ut, r, O(o(rn, a + 1, t)), n, o(tn, a, t));
...
f(function(r, n) {
  ...
  if (t.b) {
    var e = t.a;
    return d(ot, r, O(o(rn, e + 1, n)), o(tn, e, n));
  } else return d(ot, r, J, n);
});
var Ln = function(r) {
}, ur = _r, Wu = ur(0), Zt = k(function(r, n, t, e) {
  if (e.b) {
    var a = e.a, u = e.b;
    if (u.b) {
      var i = u.a, $ = u.b;
...
var Gu = St("Task"), Wn = f(function(r, n) {
  ...
  return no(_([ro(J), o(R, O, r)]));
}, U = Ze, xt = o(B, function(r) {
  return o(R, r, o(F, "timestamp", Nt));
}, o(B, function(r) {
  return o(R, r, o(F, "text", U));
}, o(B, function(r) {
  return o(R, r, o(F, "author_name", U));
}, o(B, function(r) {
  return o(R, r, o(F, "parent_id", to(U)));
}, o(B, function(r) {
  return o(R, r, o(F, "guest_id", U));
}, o(B, function(r) {
  return o(R, r, o(F, "item_id", U));
}, o(B, function(r) {
  return o(R, r, o(F, "id", U));
}, sr(xu)))))))), re = o(B, function(r) {
  return o(R, r, o(F, "timestamp", Nt));
}, o(B, function(r) {
  return o(R, r, o(F, "comments", Dn(xt)));
}, o(B, function(r) {
  return o(R, r, o(F, "tags", Dn(U)));
}, o(B, function(r) {
  return o(R, r, o(F, "owner_comment", U));
}, o(B, function(r) {
  return o(R, r, o(F, "extract", U));
}, o(B, function(r) {
  return o(R, r, o(F, "image", U));
}, o(B, function(r) {
  return o(R, r, o(F, "link", U));
}, o(B, function(r) {
  return o(R, r, o(F, "title", U));
}, o(B, function(r) {
  return o(R, r, o(F, "id", U));
}, sr(Nu)))))))))), eo = o(B, function(r) {
  return o(R, r, o(F, "items", Dn(re)));
}, sr(Ku)), ao = function(r) {
  ...
  if (a.$ === -1 && !a.a) {
    ...
    m.a;
    var S = m.b, E = m.c, H = m.d, M = m.e, s = e.e;
    return h(g, 0, l, v, h(g, 1, S, E, H, M), h(g, 1, n, t, s, a));
  ...
  if (r.$ === -1 && r.d.$ === -1 && r.e.$ === -1) if (r.e.d.$ === -1 && !r.e.d.a) {
    ...
    s.a;
    var m = s.b, S = s.c, E = s.d, H = s.e, M = l.e;
    return h(g, 0, m, S, h(g, 1, t, e, h(g, 0, u, i, $, c), E), h(g, 1, v, p, H, M));
  } else {
    var n = r.a, t = r.b, e = r.c, j = r.d;
    j.a;
    var u = j.b, i = j.c, $ = j.d, c = j.e, L = r.e;
    L.a;
    var v = L.b, p = L.c, s = L.d, M = L.e;
    return h(g, 1, t, e, h(g, 0, u, i, $, c), h(g, 0, v, p, s, M));
  }
  else return r;
}, $t = function(r) {
  if (r.$ === -1 && r.d.$ === -1 && r.e.$ === -1) if (r.d.d.$ === -1 && !r.d.d.a) {
    ...
    m.a;
    var S = m.b, E = m.c, H = m.d, M = m.e;
    return h(g, 0, u, i, h(g, 1, c, l, v, p), h(g, 1, t, e, s, h(g, 0, S, E, H, M)));
  } else {
    var n = r.a, t = r.b, e = r.c, j = r.d;
    j.a;
    var u = j.b, i = j.c, L = j.d, s = j.e, tr = r.e;
    tr.a;
    var S = tr.b, E = tr.c, H = tr.d, M = tr.e;
    return h(g, 1, t, e, h(g, 0, u, i, L, s), h(g, 0, S, E, H, M));
  }
  else return r;
  ...
  return { aR: r, a1: n };
}), Mo = ur(o(fe, An, w)), Ro = ha, Fo = Jn, qr = D(function(r, n, t) {
  r: for (; ; ) if (n.b) {
    var e = n.a, a = n.b;
    if (e.$) {
      var p = e.a;
  ...
  return d(Or, To(r), w, n);
}), Vo = k(function(r, n, t, e) {
  var a = e.a, u = e.b;
  return $r(n, a) ? O(o(Un, r, u(t))) : J;
}), Oo = D(function(r, n, t) {
  var e = n.a, a = n.b;
...
gr.Http = At(Mo, Bo, Oo, Lo, Uo);
var Wo = St("Http"), zo = function(r) {
  return Wo(ce({ ba: false, I: r.I, bf: r.bf, bh: r.bh, bl: r.bl, bv: r.bv, bw: r.bw, by: r.by }));
}, kn = f(function(r, n) {
  return zo({ I: Jo(n.I), bf: o(jo, r, n.J), bh: _([o(Ho, "X-RPC-Endpoint", n.K)]), bl: "POST", bv: J, bw: J, by: "/api/" + n.K });
}), jn = o(kn, Xu, ao({ k: "localhost" })), ko = A({ Q: "", n: wn, t: "", z: J }, jn), qo = jt, Qo = qo(w), ln = function(r) {
  return { $: 2, a: r };
}, yo = function(r) {
  return { $: 1, a: r };
}, vn = function(r) {
  ...
  return zn(_([A("host", I(r.k)), A("item_id", I(r.Y)), A("parent_id", o(ct, vt(lt), ft(I))(r.ab)), A("text", I(r.ae)), A("author_name", o(ct, vt(lt), ft(I))(r.Q))]));
}, Zo = function(r) {
  return { ap: r };
}, Ko = o(B, function(r) {
  return o(R, r, o(F, "comment", xt));
}, sr(Zo)), No = function(r) {
  ...
  return o(kn, Yo, No({ Q: Vr(r.Q) ? J : O(r.Q), k: "localhost", Y: t, ab: e, ae: r.t }));
}, ri = function(r) {
  return { $: 2, a: r };
}, ni = f(function(r, n) {
  return d(Cr, va(r), ca(), n);
}), ti = function(r) {
  return zn(_([A("host", I(r.k)), A("title", I(r.ag)), A("link", I(r.Z)), A("image", I(r.W)), A("extract", I(r.V)), A("owner_comment", I(r.aa)), A("tags", ni(I)(r.F))]));
}, ei = function(r) {
  return { aE: r };
}, ai = o(B, function(r) {
  return o(R, r, o(F, "item", re));
}, sr(ei)), ui = function(r) {
  return { I: ti(r), J: ai, K: "SubmitItem" };
}, oi = o(kn, ri, ui({ V: "This item was submitted via the generated Elm API.", k: "localhost", W: "https://placehold.co/100x100", Z: "https://elm-lang.org", aa: "So much cleaner!", F: w, ag: "New Item from Elm" })), ii = f(function(r, n) {
  switch (r.$) {
    case 0:
      return A(n, oi);
    case 1:
    ...
    case 3:
      var a = r.a, u = r.b;
      return A(Z(n, { t: "", z: O({ Y: a, ab: u }) }), er);
    case 4:
      var i = r.a;
      return A(Z(n, { t: i }), er);
    case 5:
...
}), $i = { $: 0 }, Jr = q("button"), C = q("div"), ci = q("h1"), fi = function(r) {
  return { $: 0, a: r };
}, le = Et, li = f(function(r, n) {
  return o(le, r, fi(n));
}), Mr = function(r) {
  return o(li, "click", sr(r));
}, vi = Ma, b = vi, si = _n, V = si, ve = q("h2"), mi = q("a"), se = f(function(r, n) {
  return d(Or, f(function(t, e) {
...
}, _i = q("h3"), en = f(function(r, n) {
  return o(Ra, r, I(n));
}), bi = function(r) {
  return o(en, "href", Ca(r));
}, hi = q("img"), di = q("p"), gi = q("section"), wi = function(r) {
  ...
  return d(Or, F, n, r);
}), Bi = o(Fi, _(["target", "value"]), U), mt = function(r) {
  return o(Ri, "input", o(R, Ji, o(R, r, Bi)));
}, pt = en("placeholder"), Ti = q("textarea"), _t = en("value"), me = D(function(r, n, t) {
  var e = r.z;
  if (e.$) return o(Jr, _([Mr(o(st, n, t)), o(b, "font-size", "0.8em"), o(b, "color", "gray"), o(b, "background", "none"), o(b, "border", "none"), o(b, "cursor", "pointer"), o(b, "text-decoration", "underline")]), _([V("Reply")]));
  var a = e.a;
  return $r(a.Y, n) && $r(a.ab, t) ? o(C, _([o(b, "margin-top", "5px"), o(b, "background", "#f0f0f0"), o(b, "padding", "10px")]), _([o(Hi, _([pt("Your Name (Optional for returning users)"), _t(r.Q), mt(ji), o(b, "display", "block"), o(b, "margin-bottom", "5px"), o(b, "width", "100%")]), w), o(Ti, _([pt("Write a reply..."), _t(r.t), mt(Ei), o(b, "width", "100%"), o(b, "height", "60px")]), w), o(C, _([o(b, "margin-top", "5px")]), _([o(Jr, _([Mr(Si), o(b, "margin-right", "5px")]), _([V("Submit")])), o(Jr, _([Mr(Ai)]), _([V("Cancel")]))]))])) : o(Jr, _([Mr(o(st, n, t)), o(b, "font-size", "0.8em"), o(b, "color", "gray"), o(b, "background", "none"), o(b, "border", "none"), o(b, "cursor", "pointer"), o(b, "text-decoration", "underline")]), _([V("Reply")]));
}), pe = k(function(r, n, t, e) {
  return o(C, _([o(b, "margin-left", "20px"), o(b, "margin-top", "10px"), o(b, "border-left", "2px solid #eee"), o(b, "padding-left", "10px")]), _([o(C, _([o(b, "font-weight", "bold"), o(b, "font-size", "0.9em")]), _([V(e.Q)])), o(C, w, _([V(e.ae)])), d(me, r, n, O(e.r)), o(C, w, o(Tr, d(pe, r, n, t), o(Di, e.r, t)))]));
}), Ci = function(r) {
  return o(C, _([o(b, "display", "inline-block"), o(b, "background-color", "#e0e0e0"), o(b, "color", "#333"), o(b, "padding", "2px 8px"), o(b, "border-radius", "12px"), o(b, "font-size", "0.85em"), o(b, "margin-right", "5px")]), _([V(r)]));
}, Vi = f(function(r, n) {
  return o(gi, _([o(b, "border", "1px solid #ddd"), o(b, "padding", "15px"), o(b, "margin-bottom", "15px"), o(b, "border-radius", "8px")]), _([o(ve, w, _([V(n.ag)])), o(mi, _([bi(n.Z), o(b, "color", "blue")]), _([V(n.Z)])), o(C, _([o(b, "margin", "10px 0")]), _([o(hi, _([wi(n.W), o(b, "max-width", "100%"), o(b, "height", "auto")]), w)])), o(di, w, _([V(n.V)])), o(C, _([o(b, "margin-bottom", "10px")]), o(Tr, Ci, n.F)), o(C, _([o(b, "background", "#f9f9f9"), o(b, "padding", "10px"), o(b, "font-style", "italic")]), _([V("Owner: " + n.aa)])), o(C, _([o(b, "margin-top", "20px"), o(b, "border-top", "1px solid #eee"), o(b, "padding-top", "10px")]), _([o(_i, w, _([V("Comments")])), o(C, w, o(Tr, d(pe, r, n.r, n.aq), pi(n.aq))), d(me, r, n.r, J)]))]));
}), Oi = function(r) {
  var n = r.n;
  switch (n.$) {
    case 0:
      return o(C, w, _([V("Loading Feed...")]));
    case 1:
      var t = n.a;
      return o(C, w, o(Tr, Vi(r), t));
    default:
      var e = n.a;
      return o(C, _([o(b, "color", "red")]), _([o(ve, w, _([V("Error")])), o(C, w, _([V(e)]))]));
  }
}, Pi = function(r) {
  return o(C, _([o(b, "font-family", "sans-serif"), o(b, "max-width", "800px"), o(b, "margin", "0 auto"), o(b, "padding", "20px")]), _([o(ci, w, _([V("Horatio Reader")])), o(Jr, _([Mr($i), o(b, "margin-bottom", "20px")]), _([V("Test: Submit Item")])), Oi(r)]));
}, Li = Yu({ bk: function(r) {
  return ko;
}, bu: function(r) {
  return Qo;
...
async function Ui() {
  ...
  console.log("Using server-managed session cookies"), window.HAMLET_SESSION_ID = null;
